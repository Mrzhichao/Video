            ...
            <div class="container-fluid am-cf">
                <div class="row">
                   <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span>轮播管理 ><small>添加轮播</small></div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="{{ url('admin/carousel/') }}" method="post" enctype="multipart/form-data" class="am-form tpl-form-border-form">
                                   ...
                                   <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text" placeholder="轮播视频名称" name="cname" id="user-name" class="tpl-form-input am-margin-top-xs">
                                ...
                                <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text" readonly=""    id="user-name" value="{{$data->vname}}" class="tpl-form-input am-margin-top-xs">
