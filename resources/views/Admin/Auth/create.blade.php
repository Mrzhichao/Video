            ...
            <div class="container-fluid am-cf">
                <div class="row">
                   <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span>权限管理 ><small>添加权限</small></div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="{{ url('admin/auth/') }}" method="post" enctype="multipart/form-data" class="am-form tpl-form-border-form">
                                ...
                                <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text"    id="user-name" name="aname" value="" class="tpl-form-input am-margin-top-xs">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12">
                                            <input type="text"    id="user-name" name="adesc" value="App\Http\Controllers\Admin\" class="tpl-form-input am-margin-top-xs">
