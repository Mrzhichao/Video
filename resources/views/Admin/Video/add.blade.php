                            ...
                            <div class="widget-body am-fr">   
                                ...
                                <form action="{{ url('admin/video') }}" class="am-form tpl-form-line-form" method='post' enctype="multipart/form-data"> 
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" name='userid' value="{{ old('userid') }}" style="display: none;">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name='publicTime' class="am-form-field tpl-form-no-bg" placeholder="发布时间" data-am-datepicker="" readonly="">
                                            <small>上映时间为必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <span class="tpl-form-line-small-title">Time</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="am-form-field tpl-form-no-bg" name='projectionTime' placeholder="发布时间" data-am-datepicker="" readonly="">
                                            <small>下映时间必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" rows="10" name='keywords' id="user-intro" value="{{ old('introduction') }}" placeholder="请输入视频关键词">
                                        </div>
                                    </div>
