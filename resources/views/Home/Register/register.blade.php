                     ...
                     <div class="content-box-opa dark-bg">
                        <article>
                              <div class="col-lg-12 col-md-12 col-sm-12 post post-medium">
                                    <center><h2>修 改 密 码</h2></center>
                                    <br>
                                     
                                    <form name="comment-form1" method="post" action="{{url('home/doreset')}}" id="comment-form1" enctype="multipart/form-data">
                                       <fieldset>
                                       {{csrf_field()}}
                                       ...
                                       @if (count($errors) > 0)
                                        ...
                                        <div id='msg' class="am-btn-group am-btn-group-xs">
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <input type="text" name="user" id="contactname" value="{{old('')}}" placeholder="用户名|手机号|邮箱" onfocus="if (this.value=='Your name') this.value = ''">
                                             </div>
                                             <div class="col-md-12" style="height:20px">
                                                </div>
                                             <div class="col-md-12">
                                                <input type="password" name="upwd" id="contactname" value="{{old('')}}" placeholder="密码" onfocus="if (this.value=='Your name') this.value = ''">
                                             </div>
                                             <div class="col-md-12" style="height:20px">
                                                </div>
                                             <div class="col-md-12">
                                                <input type="password" name="re_upwd" id="contactname" value="{{old('')}}" placeholder="确定密码" onfocus="if (this.value=='Your name') this.value = ''">
                                             </div>
                                             <div class="col-md-12" style="height:20px">
                                                </div>
                                             
                                             <div class="col-md-12">
                                                <button class="subscribe-btn" >修改密码</button>
                                             </div>
                                          </div>
